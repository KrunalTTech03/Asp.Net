...
namespace StudentCoreWebApi.Interface
{
    ...
    {
        Task<ApiResponse<object>> GetAllUserstempAsync(Guid userId);
        ...
        Task<ApiResponse<LoginResponseDto>> MimicLoginAsync(Guid adminUserId, string targetEmail, JwtTokenService jwtTokenService);
        Task<ApiResponse<CurrentUserProfileDto>> GetCurrentUserProfileAsync(Guid userId);
